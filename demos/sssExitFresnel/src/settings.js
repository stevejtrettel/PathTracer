...
//camera: identical to demos/sssExit — the point is a pixel-comparable A/B.
...
//the whole point of this page: Fresnel/TIR at the walk's exit boundary,
//see docs/material-system.md §5
let defines = ['SSS_EXIT_FRESNEL'];

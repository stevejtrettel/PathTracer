...
//
//    //----------- BARTH SEXTIC -------------------------
//    sextic.center=Point(vec3(0,2,0));
//    sextic.scale=2.;
//
...
//    sextic.boundingBox.radius=3.;
//    sextic.boundingBox.mat=air(vec3(0));
//    //makeGlass(0.5*vec3(0.3,0.05,0.08),1.4,0.99);
//    //air(vec3(0.2,0.1,0.));
//}
//
//
...
//
//    insideVar = inside(path.tv, sextic.boundingBox);
//

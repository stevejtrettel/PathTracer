...
//the standard interface: initObject, world sdf/at/inside, normalVec, setData.
//(the sdf clips itself to the unit ball, so it raymarches like any other object;
//no custom trace/at needed.)
OBJECT_API(Gasket)

...
//roughness is shared by both rows so the comparison stays honest.
export const params = [
    { name: 'roughness',  label: 'Roughness',   min: 0, max: 1,   step: 0.01, value: 0.05 },
    { name: 'maxIOR',     label: 'Max IOR',     min: 1, max: 3,   step: 0.01, value: 2.5 },

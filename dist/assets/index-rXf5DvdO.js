...
#define LOW_PRECISION`),t}function Yh(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Cs?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===bo?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qe&&(t="SHADOWMAP_TYPE_VSM"),t}function $h(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case qn:case Yn:t="ENVMAP_TYPE_CUBE";break;case qi:t="ENVMAP_TYPE_CUBE_UV";break}return t}function jh(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Yn:t="ENVMAP_MODE_REFRACTION";break}return t}function Kh(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ls:t="ENVMAP_BLENDING_MULTIPLY";break;case Wo:t="ENVMAP_BLENDING_MIX";break;case Xo:t="ENVMAP_BLENDING_ADD";break}return t}function Zh(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Jh(i,t,e,n){const r=i.getContext(),a=e.defines;let o=e.vertexShader,s=e.fragmentShader;const l=Yh(e),c=$h(e),d=jh(e),h=Kh(e),f=Zh(e),m=e.isWebGL2?"":zh(e),_=kh(e),v=Bh(a),p=r.createProgram();let u,E,S=e.glslVersion?"#version "+e.glslVersion+`

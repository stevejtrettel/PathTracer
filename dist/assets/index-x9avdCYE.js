...
}`;const qf=new co().load("src/js/tex/office.jpg"),Yf=new co().load("src/js/tex/office.jpg");let $f={iResolution:{value:new P(window.innerWidth,window.innerHeight,0)},sky:{value:qf},skySM:{value:Yf},facing:{value:new Ct().identity()},location:{value:new P(0,0,0)},frameNumber:{value:0},aperture:{value:0},focalLength:{value:5},exposure:{value:1},focusHelp:{value:!1},fov:{value:50},renderBlocks:{value:!1},extra:{value:.5},extra2:{value:.5},extra3:{value:.5},extra4:{value:.5}};function jf(){return{tracer:{shader:Xf,uniforms:$f},accumulate:{shader:Hf,uniforms:{frameNumber:{value:0},iResolution:{value:new P(window.innerWidth,window.innerHeight,0)},accTex:{value:null},newTex:{value:null}}},display:{shader:Wf,uniforms:{iResolution:{value:new P(window.innerWidth,window.innerHeight,0)},accTex:{value:null}}}}}let Kf=document.querySelector("#World"),Zf=typeof type<"u"&&type&&!isNaN(type)?parseInt(type):0,Xi=new ri;Xi.showPanel(Zf);document.body.appendChild(Xi.dom);let Jf=jf(),uo=new Df(Jf,Kf);new Gf(uo);function ho(){requestAnimationFrame(ho),Xi.begin(),uo.newFrame(),Xi.end()}ho();

...
`+Fh(i.getShaderSource(t),o)}else return r}function Oh(i,t){const e=zh(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Bh(i,t){let e;switch(t){case $o:e="Linear";break;case jo:e="Reinhard";break;case Ko:e="OptimizedCineon";break;case Zo:e="ACESFilmic";break;case Qo:e="AgX";break;case Jo:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function kh(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(qn).join(`
`)}function Vh(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(qn).join(`
`)}function Hh(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Gh(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const a=i.getActiveAttrib(t,r),o=a.name;let s=1;a.type===i.FLOAT_MAT2&&(s=2),a.type===i.FLOAT_MAT3&&(s=3),a.type===i.FLOAT_MAT4&&(s=4),e[o]={type:a.type,location:i.getAttribLocation(t,o),locationSize:s}}return e}function qn(i){return i!==""}function ys(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ss(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Wh=/^[ \t]*#include +<([\w\d./]+)>/gm;function qr(i){return i.replace(Wh,Xh)}const qh=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Xh(i,t){let e=Dt[t];if(e===void 0){const n=qh.get(t);if(n!==void 0)e=Dt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return qr(e)}const Yh=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ms(i){return i.replace(Yh,$h)}function $h(i,t,e,n){let r="";for(let a=parseInt(t);a<parseInt(e);a++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return r}function Ts(i){let t="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?t+=`
#define HIGH_PRECISION`:i.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function jh(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ls?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===So?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===$e&&(t="SHADOWMAP_TYPE_VSM"),t}function Kh(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case $n:case jn:t="ENVMAP_TYPE_CUBE";break;case $i:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Zh(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case jn:t="ENVMAP_MODE_REFRACTION";break}return t}function Jh(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ds:t="ENVMAP_BLENDING_MULTIPLY";break;case Xo:t="ENVMAP_BLENDING_MIX";break;case Yo:t="ENVMAP_BLENDING_ADD";break}return t}function Qh(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function tf(i,t,e,n){const r=i.getContext(),a=e.defines;let o=e.vertexShader,s=e.fragmentShader;const l=jh(e),c=Kh(e),d=Zh(e),h=Jh(e),f=Qh(e),m=e.isWebGL2?"":kh(e),_=Vh(e),v=Hh(a),p=r.createProgram();let u,T,S=e.glslVersion?"#version "+e.glslVersion+`
...
vec2 sdMobius(vec3 rP, float radius, float width, float thickness, float twists, bool offset){
    ...
    float hole = length(holeInput) - r*6.2831/aN/2.*.7; 
...
}`;const Kf=new ho().load("src/js/tex/office.jpg"),Zf=new ho().load("src/js/tex/office.jpg");let Jf={iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},frameNumber:{value:0},sky:{value:Kf},skySM:{value:Zf},facing:{value:new Ct().set(jt.facing[0],jt.facing[1],jt.facing[2],jt.facing[3],jt.facing[4],jt.facing[5],jt.facing[6],jt.facing[7],jt.facing[8])},location:{value:new L(jt.position[0],jt.position[1],jt.position[2])},aperture:{value:pe.aperture},focalLength:{value:pe.focalLength},exposure:{value:pe.exposure},focusHelp:{value:!1},fov:{value:pe.fov},extra:{value:pe.extra},extra2:{value:pe.extra2},extra3:{value:pe.extra2},extra4:{value:pe.extra2},renderPanel:{value:!1},numPanels:{value:1},panelToRender:{value:0}};const Qf={tracer:{shader:jf,uniforms:Jf},accumulate:{shader:Yf,uniforms:{frameNumber:{value:0},iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},accTex:{value:null},newTex:{value:null}}},display:{shader:$f,uniforms:{iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},accTex:{value:null}}}};let tp=typeof type<"u"&&type&&!isNaN(type)?parseInt(type):0,Yi=new si;Yi.showPanel(tp);document.body.appendChild(Yi.dom);let fo=new Ff(Qf);new Xf(fo);function po(){requestAnimationFrame(po),Yi.begin(),fo.newFrame(),Yi.end()}po();

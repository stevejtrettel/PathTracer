...
#define LOW_PRECISION`),t}function jh(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ls?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===So?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===$e&&(t="SHADOWMAP_TYPE_VSM"),t}function Kh(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case $n:case jn:t="ENVMAP_TYPE_CUBE";break;case $i:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Zh(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case jn:t="ENVMAP_MODE_REFRACTION";break}return t}function Jh(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ds:t="ENVMAP_BLENDING_MULTIPLY";break;case Xo:t="ENVMAP_BLENDING_MIX";break;case Yo:t="ENVMAP_BLENDING_ADD";break}return t}function Qh(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function tf(i,t,e,n){const r=i.getContext(),a=e.defines;let o=e.vertexShader,s=e.fragmentShader;const l=jh(e),c=Kh(e),d=Zh(e),h=Jh(e),f=Qh(e),m=e.isWebGL2?"":Bh(e),_=Vh(e),v=Hh(a),p=r.createProgram();let u,T,S=e.glslVersion?"#version "+e.glslVersion+`

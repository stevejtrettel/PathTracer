...
}`;const Qf=new ho().load("src/js/tex/office.jpg"),tp=new ho().load("src/js/tex/office.jpg");let ep={iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},frameNumber:{value:0},sky:{value:Qf},skySM:{value:tp},facing:{value:new Ct().set(jt.facing[0],jt.facing[1],jt.facing[2],jt.facing[3],jt.facing[4],jt.facing[5],jt.facing[6],jt.facing[7],jt.facing[8])},location:{value:new L(jt.position[0],jt.position[1],jt.position[2])},aperture:{value:pe.aperture},focalLength:{value:pe.focalLength},exposure:{value:pe.exposure},focusHelp:{value:!1},fov:{value:pe.fov},extra:{value:pe.extra},extra2:{value:pe.extra2},extra3:{value:pe.extra2},extra4:{value:pe.extra2},renderPanel:{value:!1},numPanels:{value:1},panelToRender:{value:0}};const np={tracer:{shader:Jf,uniforms:ep},accumulate:{shader:Kf,uniforms:{frameNumber:{value:0},iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},accTex:{value:null},newTex:{value:null}}},display:{shader:Zf,uniforms:{iResolution:{value:new L(window.innerWidth,window.innerHeight,0)},accTex:{value:null}}}};let ip=typeof type<"u"&&type&&!isNaN(type)?parseInt(type):0,Yi=new si;Yi.showPanel(ip);document.body.appendChild(Yi.dom);let po=new Bf(np);new jf(po);function mo(){requestAnimationFrame(mo),Yi.begin(),po.newFrame(),Yi.end()}mo();

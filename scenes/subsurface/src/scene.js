...
import {scene, object, lib, knob, absorbFor, makeGlass, makeSubsurface,
...
export default scene({
    objects: [
        ...
        object('core', {
            ...
            nestedIn: 'shell',
            material: makeSubsurface(absorbFor(coreTint, coreDepth), 1.4, coreDensity, 1.0),
        }),

        object('shell', {
            at:       [2.0, 1.3, -1.2],
            shape:    lib.sphere({radius: 1.3}),
            material: makeGlass(absorbFor([0.9, 0.93, 0.96], 3.0), 1.5, 1.0),
        }),
